...
namespace DMZ.UI.UI
{
    public partial class FrmAlauxiliar : Basic.FrmClasse
    {
        public FrmAlauxiliar()
        {
            InitializeComponent();
        }
        private Alauxiliar _auxiliar;
        private void FrmAlauxiliar_Load(object sender, EventArgs e)
        {
            Campo1 = "codigo";
            Campo2 = "descricao";
            Ctabela = "Alauxiliar";
        ...
        {
            _auxiliar = DoAddline<Alauxiliar>();
            base.DefaultValues();
        }
