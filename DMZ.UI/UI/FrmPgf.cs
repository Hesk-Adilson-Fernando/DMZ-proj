...
namespace DMZ.UI.UI
{
    public partial class FrmPgf : FrmClasse
    {
        public Pgf _pgf;
        ...
        private void FrmPagamento_Load(object sender, EventArgs e)
        {
            ...
            Ctabela = "Pgf";
            BindGrid();
            TmpTpgf = SQL.GetRowToEnt<Tpgf>(" Defa = 1 ");// EF.QEnt<Tpgf>(" Defa = 1 ");
            SetValues();
            MultiDoc = true;
        }
        ...
        {
            _pgf = DoAddline<Pgf>();
            var m = SQL.GetRowToEnt<Moedas>(" princip = 1 ");// EF.QEnt<Moedas>(" princip = 1 ");
            ...
            _pgf.Usrstamp = Pbl.Usr.Usrstamp;
        }
        ...
        public void UpdateObjects(DataTable dt)
        {
            ...
            TmpTpgf = SQL.GetRowToEnt<Tpgf>($"numdoc={numdoc}");// EF.QEnt<Tpgf>( $"numdoc={numdoc}");
            label1.Text = TmpTpgf.Descricao;
