            ...
            if (!string.IsNullOrEmpty(comboBox1.Text.Trim()))
            {
                ...
                if (cbA4.cb1.Checked)
                {
                    ...
                    if (DadosEnviados==null)
                    {
                        if (cbA4.cb1.Checked)
                        {
                            if (!Ps.XmlStringA4.IsNullOrEmpty())
                            {
                                Ps.XmlString = Ps.XmlStringA4;
                                Ps.Nomfile = Ps.NomfileA4;
                            }
                            else
                            {
                                MsBox.Show("Este tipo de impressão não foi configurado");
                                return;
                            }
                        }
                    }
                ...
                if (cbA5.cb1.Checked)
                {
                    ...
                    if (DadosEnviados==null)
                    {
                        if (cbA5.cb1.Checked)
                        {
                            if (!Ps.XmlStringA5.IsNullOrEmpty())
                            {
                                Ps.XmlString = Ps.XmlStringA5;
                                Ps.Nomfile = Ps.NomfileA5;
                            }
                            else
                            {
                                MsBox.Show("Este tipo de impressão não foi configurado");
